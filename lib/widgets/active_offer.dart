...
/*This screen/popup should come up when the user taps on the offer. It should
contain the bank name, annual expense rate, interest rate, amount, and
maturity.*/
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            Text(
                              "%${activeOffers.annualRate?.toStringAsFixed(2)}",
